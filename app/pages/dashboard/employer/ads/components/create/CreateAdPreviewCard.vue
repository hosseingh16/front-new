  ...
  <section class="rounded-2xl border border-gray-default bg-white p-4">
    ...
    <div class="mt-6 rounded-lg bg-white p-1 shadow-sm">
      <div class="rounded-lg bg-surface-soft p-3">
        ...
        <div
          class="mt-3 flex flex-wrap gap-1 overflow-x-auto text-sm no-scrollbar"
        >
          <div
            v-if="locationLabel"
          ...
          >
            ...
            <span class="text-text-tertiary">{{ locationLabel }}</span>
          </div>
          <div
            v-if="genderLabel"
            class="flex shrink-0 items-center gap-2 rounded-full border border-gray-default bg-white px-3 py-1"
          >
            ...
            <span class="text-text-tertiary">{{ genderLabel }}</span>
          </div>
        </div>
      </div>
