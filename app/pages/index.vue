<template>
  <div class="bg-surface-50">
    ...
    <FaqSection
      class="mt-12"
      title="پاسخ به رایج‌ترین سوالات درباره خدمات های‌حساب"
      subtitle="برای یافتن پاسخ، می‌توانید از دسته‌بندی‌های زیر استفاده کنید"
      :categories="faqCategories"
      :items="faqs"
      tabs-class="grid-cols-2 sm:grid-cols-4"
      list-class=""
    />
    <!-- [END] FAQ -->
...
useSeoMeta({
  ...
  description:
    "های‌حساب، پلی میان حسابداران و کارفرمایان؛ برای رشد حرفه‌ای حسابداران و پاسخ به نیازهای مالی و حسابداری کسب‌وکارها.",
});
</script>
