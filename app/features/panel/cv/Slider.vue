<template>
  <div
    class="bg-surface-50 rounded-full py-3 px-1 md:px-1 flex items-center justify-center gap-px [&>div:nth-child(odd)]:cursor-pointer"
  >
    <div class="relative">
      <div
...
<!-- <template>
  <div class="bg-surface-50 rounded-full py-3 px-1 md:px-1">
    <div
      class="flex items-center justify-center gap-px [&>div:nth-child(odd)]:cursor-pointer"
    >
      <div class="relative">
        <div
          class="rounded-full w-1 h-1"
      ...
      <div
        class="rounded-full w-5 md:w-6 h-1"
        :style="`background-color: ${model >= 1 ? color : '#EBEBEB'}`"
      ></div>
      <div class="relative">
        <div
      ...
      <div
        class="rounded-full w-5 md:w-6 h-1.25"
        :style="`background-color: ${model >= 2 ? color : '#EBEBEB'}`"
      ></div>
      <div class="relative">
        <div
      ...
      <div
        class="rounded-full w-5 md:w-6 h-1.5"
        :style="`background-color: ${model >= 3 ? color : '#EBEBEB'}`"
      ></div>
      <div class="relative">
        <div
      ...
      <div
        class="rounded-full w-5 md:w-6 h-1.75"
        :style="`background-color: ${model >= 4 ? color : '#EBEBEB'}`"
      ></div>
      <div class="relative">
        <div
      ...
      <div
        class="rounded-full w-5 md:w-6 h-2"
        :style="`background-color: ${model >= 5 ? color : '#EBEBEB'}`"
      ></div>
      <div class="relative">
        <div
      ...
      <div
        class="rounded-full w-5 md:w-6 h-2.25"
        :style="`background-color: ${model >= 6 ? color : '#EBEBEB'}`"
      ></div>
      <div class="relative">
        <div
      ...
      <div
        class="rounded-full w-5 md:w-6 h-2.5"
        :style="`background-color: ${model >= 7 ? color : '#EBEBEB'}`"
      ></div>
      <div class="relative">
        <div
      ...
      <div
        class="rounded-full w-5 md:w-6 h-2.75"
        :style="`background-color: ${model >= 8 ? color : '#EBEBEB'}`"
      ></div>
      <div class="relative">
        <div
      ...
      <div
        class="rounded-full w-5 md:w-6 h-3"
        :style="`background-color: ${model >= 9 ? color : '#EBEBEB'}`"
      ></div>
      <div class="relative">
        <div
      ...
      <div
        class="rounded-full w-5 md:w-6 h-3.25"
        :style="`background-color: ${model >= 10 ? color : '#EBEBEB'}`"
      ></div>
      <div class="relative">
        <div
