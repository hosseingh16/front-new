  ...
  <article class="rounded-lg bg-white p-1">
        ...
        <div class="min-w-0 flex-1">
          ...
          <div class="mt-1 flex items-center justify-between gap-2">
            <div class="flex min-w-0 items-center gap-1 text-sm">
              <Icon name="svg:buildings-4" size="20" class="shrink-0 text-text-passive" />
              <span class="text-text-passive">نام شرکت:</span>
              <span class="truncate text-text-tertiary">{{ request.company_name }}</span>
            </div>
    ...
    <div class="flex items-center justify-between p-2">
      ...
      <div class="flex items-center gap-2">
        ...
        >
          جزئیات
          <Icon name="svg:chevron-left" size="20" />
        </button>
        <button
          type="button"
