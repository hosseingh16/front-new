<template>
  <aside
    class="fixed top-0 right-0 flex h-full w-72 flex-col border-l-2 border-t-2 border-gray-default bg-base-100 px-4 py-5 transition-transform duration-300 max-lg:hidden [&_.btn]:text-sm [&_.btn]:font-normal"
