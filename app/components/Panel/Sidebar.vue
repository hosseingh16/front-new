<template>
  ...
  >
    <div class="flex flex-col gap-y-2 pt-16">
      <NuxtLink to="#" v-for="item in menus1">
        <button
        ...
        >
          <div class="flex justify-start items-center">
            ...
            <span class="text-text-secondary mr-2">{{ item.title }}</span>
          </div>
  ...
  <!-- <div class="drawer drawer-open w-72 fixed top-0">
    <input id="my-drawer-1" type="checkbox" class="drawer-toggle" />
    <div class="drawer-side">
      <label for="my-drawer-1" aria-label="close sidebar" class="drawer-overlay"></label>
      <div
        class="h-full py-5 bg-white w-72 border-l-2 border-t-2 border-gray-default flex flex-col justify-between max-lg:hidden [&_button]:text-sm [&_button]:font-normal"
      >
        <div class="flex flex-col gap-y-2">
          <NuxtLink to="#" v-for="item in menus1">
            <button
